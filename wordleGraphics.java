...
public class wordleGraphics extends JPanel implements KeyListener {
	...
	public void drawKeyboard( Graphics window) //draws the keyboard at the bottom
	{
		...
		for(int a=0;a<rowOne.length();a++) {
			String charString = "" + rowOne.charAt(a);
			if(keyboardLetters.get(rowOne.charAt(a)).contentEquals("Green")) {
				window.setColor(Color.GREEN);
			}
			if(keyboardLetters.get(rowOne.charAt(a)).contentEquals("Yellow")) {
				window.setColor(Color.YELLOW);
			}
			...
			window.fillRect(i, j-10, keyScale, keyScale);
			window.setColor(Color.BLACK);
			window.drawString(charString, i, j);
			i+=30;
		}
		i = 140;
		j=j+20;
		for(int a=0;a<rowTwo.length();a++) {
			String charString = "" + rowTwo.charAt(a);
			if(keyboardLetters.get(rowTwo.charAt(a)).contentEquals("Green")) {
				window.setColor(Color.GREEN);
			}
			if(keyboardLetters.get(rowTwo.charAt(a)).contentEquals("Yellow")) {
				window.setColor(Color.YELLOW);
			}
		...
		i = 140;
		j=j+20;
		for(int a=0;a<rowThree.length();a++) {
			String charString = "" + rowThree.charAt(a);
			if(keyboardLetters.get(rowThree.charAt(a)).contentEquals("Green")) {
				window.setColor(Color.GREEN);
			}
			if(keyboardLetters.get(rowThree.charAt(a)).contentEquals("Yellow")) {
				window.setColor(Color.YELLOW);
			}
	...
	public boolean isWon() {
		for(int x=0;x<sol.length();x++) {
			if(!(keyboardLetters.get(sol.charAt(x)).equals("Green"))) {
				return false;
			}
		}
		return true;
